...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function showToast(message, type = 'success') { /* ... copy hàm showToast từ user-dashboard.js ... */ }
    ...
    form.addEventListener('submit', async function(e) {
        ...
        const body = { name: nameInput.value, phone: phoneInput.value };
        ...
        try {
            ...
            // Cập nhật lại tên trên header nếu có
            if (window.opener && window.opener.document) {
                const userNameEl = window.opener.document.querySelector('.user-name');
